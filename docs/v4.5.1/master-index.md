...
| `docs/KILLER_SYSTEM.md` | Details the Timer, Heat, Archetypes, and Dynamic Planting mechanics. | **Active** |
| `docs/CIVILIAN_SYSTEM.md` | Details the movement AI, **Heat Response (Panic)**, and camouflage logic. | **Active** |
...
2.  **`CIVILIAN_SYSTEM.md`** → depends on **`docs/KILLER_SYSTEM.md`**: Subscribes to `killerHeat` to trigger Panic states.
